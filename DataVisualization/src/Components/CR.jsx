...
const CorrosionRate = () => {
  ...
  const yKey4 = 'Sce-1 CCR - O2 mmpy';
  const yKey5 = 'Sce-1 CCR - MIC mmpy';
  const yKey6 = 'Sce-1 CCR - General mmpy';
  ...
  const options = {
    ...
    plugins: {
      title: {
        display: true,
        text: `Elevation & Corrosion Rate Scenario 1`,
      },
      legend: {
        display: true,
      },
  ...
  return(
    <div style = {{ maxWidth: '100%',
      ...
      <h2>Corrosion Rate Scenario-1</h2>
