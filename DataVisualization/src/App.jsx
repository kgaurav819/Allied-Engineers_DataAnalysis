...
//major Changes
import CR2_Chunk from './Components/CR_Sce2_Chunk'
import Consolidated_CR_Chunk from './Components/Consolidate_CR_Chunk'
import PressureDrop_Chunks from './Components/PressureDrop_Chunk';
import ChartSelector_ICE from './Components/ChartSelector_ICE';
import TemperatureDrop_Chunks from './Components/TemperatureDrop_Chunk'
...
import VelocityProfile_Chunk from './Components/velocityProfileChunk'
      ...
      {location.pathname === "/" && <MapTilerPolyline />}
       ...
       <Routes>
        ...
        {/*Major Changes in IC*/}
         ...
         <Route path="/cr2-chunks" element={<CR2_Chunk />} />
        ...
        <Route path="/inclinationAngle-chunks" element={<InclinationAngle_Chunks />} />
